    ...
    <form action="{{ $register_url }}" method="post">
        ...
        <div class="input-group mb-3">
            <input type="password" name="password"
                   ...
                   placeholder="Senha (min 5 dígitos)" required>
            <div class="input-group-append">
                <div class="input-group-text">
        ...
        <div class="input-group mb-3">
            <input type="text" name="federacao"
                   class="form-control {{ $errors->has('federacao') ? 'is-invalid' : '' }}"
                   placeholder="Nome da UMP | Federação" required>
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="icon icon-ump"></span>
                </div>
            </div>
            @if($errors->has('federacao'))
                <div class="invalid-feedback">
                    <strong>{{ $errors->first('federacao') }}</strong>
                </div>
            @endif
        </div>
